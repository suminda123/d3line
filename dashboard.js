(function(){
    function dashboard(id, fData){
        ...
        function segColor(c){ return {Sleeperberth:"#807dba", onDuty:"#e08214",Driving:"#41ab5d"}[c]; }

        // compute total for each state.
        fData.forEach(function(d){d.total=d.freq.Sleeperberth+d.freq.onDuty+d.freq.Driving;});
        ...
        // calculate total frequency by segment for all day.
        var tF = ['Sleeperberth','onDuty','Driving'].map(function(d){
            return {type:d, freq: d3.sum(fData.map(function(t){ return t.freq[d];}))};
        });

        // calculate total frequency by day for all segment.
